...
type RouteFuelStopPresetCardProps = {
    routeLabel: string;
    fuelStationLabel: string;
...
export default function RouteFuelStopPresetCard({
    routeLabel,
    fuelStationLabel,
    distanceFromStartKm,
    notes,
        ...
        <div className="flex w-full items-center justify-between rounded-2xl border border-[#d9ded9] bg-white p-5 text-left transition hover:border-[#c7d1ca] hover:shadow-sm">
            ...
            >
                ...
                <div className="min-w-0">
                    ...
                    <p className="mt-1 text-[15px] text-[#5b6b61]">{routeLabel}</p>

                    <div className="mt-3 flex flex-wrap items-center gap-3 text-[14px] text-[#6b7a71]">
                        <span>Attālums no starta: {distanceFromStartKm} km</span>
                    </div>
